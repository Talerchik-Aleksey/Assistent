## Приложение для привлечения студентов в ГГКТиД

# 1. Цель проекта

Цель проекта — разработать систему помощи определения направления обучения (далее Система).
Пользователь имеет возможность пройти тест на определение сколонностей к различным
специальностям. Системо должна предоставлять справочную и интерактивную информацию
...
2. Функционал для определения направления
3. Функционал обеспечивающий работу с существующеми направлениями
4. Функционал платных подписок
5. Функционал интеграции с ученбными учреждениями
6. Инструменты гибкой статистика
7. Инструменты продвижения


## 2.1. Типы пользователей

Система предусматривает три типа пользователей системы: представитель учебного
заведения, абитуриент, администратор. Представитель учебного заведения ведёт
страницу учреждения, пользуется услугами продвижения, публикует статистику.
Абитуриент определяет профессиональное направление, изучет информацию по 
наврлениям, падает документы в учебные учреждения. *Администратор Верефицирует
учебные заведения.*


## 2.2. Регистрация 

Система, представлят два вида регистрации:

1. Регистрация пользователя
2. Регистрация представителя учебного учреждения
